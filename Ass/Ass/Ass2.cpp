...
Purpose:   Until the user quits with option 5, adds frames to Animations from keyboard with option 1,edit frames
with option 2 and delete all frames  with option 3. Then display the frames at 1 second interval with option 3
*********************************************************************/
